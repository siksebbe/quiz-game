$(function () {
	...
	$('.button').click(function () {
		...
		if (this.value === 'a') {
			$('body').css('background', 'url(file:///Users/sebastiangraveleij/Documents/game/css/img/history2.jpg)');
		} else if (this.value === 'b') {
			$('body').css('background-image', 'url(file:///Users/sebastiangraveleij/Documents/game/css/img/6_amon_amarth_1.jpg)');
		} else if (this.value === 'c') {
			$('body').css('background-image', 'url(file:///Users/sebastiangraveleij/Documents/game/css/img/sport5-600x400.jpg)');
		} else {
			$('body').css('background-image', 'url(file:///Users/sebastiangraveleij/Documents/game/css/img/read-books.jpg)');
		}
		$('.section.3').show();
		$('.section.1').hide();
		$('.section.2').hide();
